// Package integrationtest holds Docker-backed tests for data/lock/redislock
// so the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/lock/redislock/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/lock/redislock/v2 => ..
