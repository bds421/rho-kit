// Package integrationtest holds Docker-backed tests for pgadvisory so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/lock/pgadvisory/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/lock/pgadvisory/v2 => ..
