// Package integrationtest holds Docker-backed tests for redisstream so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/stream/redisstream/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/stream/redisstream/v2 => ..
