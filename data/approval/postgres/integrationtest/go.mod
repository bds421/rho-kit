// Package integrationtest holds Docker-backed tests for approval/postgres so
// the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/approval/postgres/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/approval/postgres/v2 => ..
