// Package integrationtest holds Docker-backed tests for data/idempotency/redisstore
// so the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/idempotency/redisstore/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/idempotency/redisstore/v2 => ..
