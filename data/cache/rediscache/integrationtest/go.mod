// Package integrationtest holds Docker-backed tests for rediscache so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/cache/rediscache/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/cache/rediscache/v2 => ..
