// Package integrationtest holds Docker-backed tests for riverqueue so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/queue/riverqueue/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/queue/riverqueue/v2 => ..
