// Package integrationtest holds Docker-backed tests for redisqueue so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/queue/redisqueue/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/queue/redisqueue/v2 => ..
