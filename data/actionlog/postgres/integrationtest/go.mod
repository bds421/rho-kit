// Package integrationtest holds Docker-backed tests for actionlog/postgres so
// the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/actionlog/postgres/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/actionlog/postgres/v2 => ..

replace github.com/bds421/rho-kit/data/v2 => ../../..
