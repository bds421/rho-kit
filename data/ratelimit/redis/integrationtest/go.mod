// Package integrationtest holds Docker-backed tests for data/ratelimit/redis
// so the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/data/ratelimit/redis/integrationtest/v2
...
replace github.com/bds421/rho-kit/data/ratelimit/redis/v2 => ..
