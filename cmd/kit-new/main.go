...
// Usage:
//
//	kit-new SERVICE_NAME -module-path github.com/org/SERVICE_NAME [-dir ./SERVICE_NAME]
//
...
func main() {
	...
	if flag.NArg() != 1 {
		fmt.Fprintln(os.Stderr, "usage: kit-new SERVICE_NAME -module-path github.com/org/SERVICE_NAME [-dir ./SERVICE_NAME]")
		os.Exit(2)
	}
	name := flag.Arg(0)
	if *modulePath == "" {
	...
	p := Params{ServiceName: name, ModulePath: *modulePath}
