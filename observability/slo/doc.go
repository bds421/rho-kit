...
// # Health Integration
//
// Use [Checker.DependencyCheck] to get a [health.DependencyCheck] that reports
// degraded status when any SLO is breached. It is non-critical by design:
// SLO breach should not make the service unready.
//
// # HTTP Endpoint
//
