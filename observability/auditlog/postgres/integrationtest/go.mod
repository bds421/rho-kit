...
// observability/auditlog/postgres so the production module does not
// pull testcontainers.
module github.com/bds421/rho-kit/observability/auditlog/postgres/integrationtest/v2

go 1.26.2

replace github.com/bds421/rho-kit/observability/auditlog/postgres/v2 => ..
...
require (
	github.com/bds421/rho-kit/infra/sqldb/dbtest/v2 v2.0.0-00010101000000-000000000000
	github.com/bds421/rho-kit/observability/auditlog/postgres/v2 v2.0.0-00010101000000-000000000000
