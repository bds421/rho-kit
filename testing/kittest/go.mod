...
require (
	...
	github.com/bds421/rho-kit/infra/storage/storagetest/v2 v2.7.0
...
require (
	...
	github.com/bds421/rho-kit/infra/storage/s3backend/v2 v2.7.0 // indirect
	github.com/bds421/rho-kit/infra/storage/sftpbackend/v2 v2.7.0 // indirect
