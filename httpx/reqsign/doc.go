...
// parameters, body, and Content-Type are all covered by the signature. HOST is
// the effective request host, lowercased, which binds signatures to the
// receiving authority and prevents cross-service replay when a key is
// accidentally reused.
//
// # Headers
//
