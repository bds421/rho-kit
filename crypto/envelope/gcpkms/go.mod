// Package gcpkms implements [crypto/envelope.KEK] against GCP KMS.
// v2 added cloud KMS adapters because the kekstatic adapter
// (in-process key) doesn't satisfy ASVS V6.4.1 in production — keys
// must live in a managed KMS with audit + rotation.
//
