// Package integrationtest holds Docker-backed tests for crypto/encrypt so the
// production crypto module does not pull Testcontainers.
module github.com/bds421/rho-kit/crypto/encrypt/integrationtest/v2
