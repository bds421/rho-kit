...
| `github.com/bds421/rho-kit/realtime/centrifuge/v2` | Adapter | No rename/remove | Browser-facing real-time framework wrapping github.com/centrifugal/centrifuge with kit lifecycle, JWT auth, bounded channel-class metrics, and structured logging. |
