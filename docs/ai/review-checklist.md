...
- [ ] New modules have `go.mod` and are listed in `go.work`
- [ ] Release docs and pre-tag gates cover new module paths (`API_FREEZE_V2.md`, `TAGGING_PLAN_V2.md`, `make check-publishable`)
