...
// infra/outbox/postgres so the production module does not pull
// testcontainers.
module github.com/bds421/rho-kit/infra/outbox/postgres/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/outbox/postgres/v2 => ..
