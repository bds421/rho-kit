// Package redistest contains Docker-backed Redis test helpers. It is split
// from infra/redis/v2 so production Redis consumers do not pull Testcontainers.
module github.com/bds421/rho-kit/infra/redis/redistest/v2
...
replace github.com/bds421/rho-kit/infra/redis/v2 => ..
