// Package integrationtest holds Docker-backed tests for natsbackend so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/infra/messaging/natsbackend/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/messaging/natsbackend/v2 => ..
