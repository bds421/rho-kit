// Package integrationtest holds Docker-backed tests for amqpbackend so the
// production module does not pull Testcontainers.
module github.com/bds421/rho-kit/infra/messaging/amqpbackend/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/messaging/amqpbackend/v2 => ..
