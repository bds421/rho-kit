// Package integrationtest holds Docker-backed tests for infra/messaging/redisbackend
// so the production module does not pull Testcontainers.
module github.com/bds421/rho-kit/infra/messaging/redisbackend/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/messaging/redisbackend/v2 => ..

replace github.com/bds421/rho-kit/infra/v2 => ../../..

replace github.com/bds421/rho-kit/infra/redis/v2 => ../../../redis

replace github.com/bds421/rho-kit/infra/redis/redistest/v2 => ../../../redis/redistest
