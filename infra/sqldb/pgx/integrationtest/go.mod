// Package integrationtest holds Docker-backed tests for pgx so the
// production pgx module does not pull Testcontainers.
module github.com/bds421/rho-kit/infra/sqldb/pgx/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/sqldb/dbtest/v2 => ../../dbtest

replace github.com/bds421/rho-kit/infra/sqldb/pgx/v2 => ..
