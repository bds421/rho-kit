...
// infra/leaderelection/redislock so the production module does not pull
// Testcontainers.
module github.com/bds421/rho-kit/infra/leaderelection/redislock/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/leaderelection/redislock/v2 => ..
