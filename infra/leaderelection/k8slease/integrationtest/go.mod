// Package integrationtest holds the fake-clientset-backed leader-election
// scenarios for infra/leaderelection/k8slease so the production module
// keeps its go.sum free of the apiserver mocking deps that ride along
// with k8s.io/client-go/kubernetes/fake.
module github.com/bds421/rho-kit/infra/leaderelection/k8slease/integrationtest/v2
...
replace github.com/bds421/rho-kit/infra/leaderelection/k8slease/v2 => ..
